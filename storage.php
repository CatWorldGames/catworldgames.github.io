<html>
 ...
 <title>CatWorldStorageImage</title>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
 ...
 echo '<div style = "border-radius:10px;border:1px solid black;"><p>Загрузка прошла удачно </p>"'.' ' . 'https://api-catworldgames.000webhostapp.com/'.$path.$_FILES['picture']['name'].'"</div><br>';
echo '<img src ="' . $path . $_FILES['picture']['name'] . '"></img>';
...
?>
 ...
 <br>
 <input type="submit" class = "load" value="Загрузить">
 </form>
 </form>
 </body>
</html>
